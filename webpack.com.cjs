...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ template: "./src/template/en/calcium.ejs", filename: "calcium/index.html", inject: "body", }),
        ...
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/turmeric.ejs", filename: "vitamin/turmeric/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/lion.ejs", filename: "vitamin/lion/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/ginko.ejs", filename: "vitamin/ginko/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/collagen.ejs", filename: "vitamin/collagen/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/bodysize/adonis.ejs", filename: "bodysize/adonis/index.html", inject: "body" }),
        ...
        new HtmlWebpackPlugin({ template: "./src/template/en/calcium.ejs", filename: "calcium.html", inject: "body", }),
        ...
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/turmeric.ejs", filename: "vitamin/turmeric.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/lion.ejs", filename: "vitamin/lion.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/ginko.ejs", filename: "vitamin/ginko.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/vitamin/collagen.ejs", filename: "vitamin/collagen.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: "./src/template/en/bodysize/adonis.ejs", filename: "bodysize/adonis.html", inject: "body" }),
        ...
        new CopyPlugin({
            patterns: [
                ...
                { context: "src/data/article/bodysize/", from: "**/*.json", to: "data/article/bodysize/[path][name][ext]" },
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/calcium.ejs`, filename: x + "/calcium/index.html", inject: "body", }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/acai.ejs`, filename: x + "/vitamin/acai/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/turmeric.ejs`, filename: x + "/vitamin/turmeric/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/lion.ejs`, filename: x + "/vitamin/lion/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/ginko.ejs`, filename: x + "/vitamin/ginko/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/collagen.ejs`, filename: x + "/vitamin/collagen/index.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/bodysize/adonis.ejs`, filename: x + "/bodysize/adonis/index.html", inject: "body" }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/calcium.ejs`, filename: x + "/calcium.html", inject: "body", }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/acai.ejs`, filename: x + "/vitamin/acai.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/turmeric.ejs`, filename: x + "/vitamin/turmeric.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/lion.ejs`, filename: x + "/vitamin/lion.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/ginko.ejs`, filename: x + "/vitamin/ginko.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/collagen.ejs`, filename: x + "/vitamin/collagen.html", inject: "body" }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/bodysize/adonis.ejs`, filename: x + "/bodysize/adonis.html", inject: "body" }),
