...
export default function Share(props: ShareProps) {
    ...
    React.useEffect(() => {
        setShareText(encodeURIComponent(props.text));
        setShareLink(encodeURIComponent(props.link));
    })
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-header">
                        <div className="row">
                            <div className="col-12 title">
                                {_("QUESTION.PROFILE_SHARE_TITLE")}
                            </div>


                            <div className="col-12">

                                <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=${shareLink}`} target="_blank" rel="noopener" aria-label="">
                                ...
                                <a className="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text=${shareText}%0D%0A&url=${shareLink}`} target="_blank" rel="noopener" aria-label="">
                                ...
                                <a className="resp-sharing-button__link" href={`mailto:?subject=${shareText}&body=${shareLink}`} target="_self" rel="noopener" aria-label="">
                                ...
                                <a className="resp-sharing-button__link" href={`https://www.linkedin.com/shareArticle?mini=true&url=${shareLink}&title=${shareText}&summary=${shareText}&source=${shareLink}`} target="_blank" rel="noopener" aria-label="">
                                ...
                                <a className="resp-sharing-button__link" href={`https://wa.me/?text=${shareText}%0D%0A${shareLink}`} target="_blank" rel="noopener" aria-label="">
                                ...
                                <a className="resp-sharing-button__link" href={`https://telegram.me/share/url?text=${shareText}&url=${shareLink}`} target="_blank" rel="noopener" aria-label="">
                    ...
                    <div className="modal-body">
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" value={props.link} disabled={true} />
