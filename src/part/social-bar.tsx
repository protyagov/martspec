...
export default function SocialBar(props: SocialBarProps) {
    ...
    return <div className={"d-flex justify-content-center flex-nowrap social-bar-" + props.color}>
        <a href="https://www.linkedin.com/company/martspec" target="_blank" rel="noopener" aria-label="">
            <svg {...svgAttrs}>
        ...
        <a href={`mailto:support@martspec.com?subject=Martspec Question&body=I have a question about your products. `} target="_self" rel="noopener" aria-label="">
            <svg {...svgAttrs}>
        ...
        <a href="https://twitter.com/MartspecCom" target="_blank" rel="noopener" aria-label="">
            <svg {...svgAttrs}>
                <path d="M25.1761 12H27.9362L21.9061 18.3538L29 27H23.4447L19.0943 21.7562L14.1164 27H11.3546L17.8043 20.2038L11 12H16.6946L20.627 16.7931L25.1744 12H25.1761ZM24.2073 25.4769H25.7368L15.8644 13.4431H14.2232L24.2073 25.4769Z" fill="currentColor"/>
            </svg>
        </a>

        <a href="https://www.facebook.com/martspec" target="_blank" rel="noopener" aria-label="">
            <svg {...svgAttrs}>
