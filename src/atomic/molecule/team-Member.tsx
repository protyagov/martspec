...
export default function TeamMember(props: TeamMemberProps) {
    ...
    function ItemLink() {
        if (item.length > 0 && item.includes("https://")) {
            return (
                <a href={_(props.link)} target="_blank" rel="noopener" aria-label="LinkedIn" className="linkedin-icon">
                    <svg {...svgAttrs}>
        ...
        <div className="col mb-2">
            <div className="card bg-card rounded-5 h-100 d-flex flex-column " >
                ...
                <div className="card-body ">
                    ...
                    <h5 className="card-subtitle text-muted pe-4"> {_("TEAM." + props.title)}
