                ...
                <div className="col-12 col-lg-6 mb-4 ">
                    <div className="card bg-card rounded-5 flex-row flex-grow-1 h-100" >
                        ...
                        <div className="col-md-7 d-flex flex-column justify-content-center p-4">
                            ...
                            <h3 className="card-title-big ms-team-info-section-h4  text-lg-start">{_("TEAM." + props.name)}</h3>
        ...
        <div className="col mb-2">
            <div className="card bg-card rounded-5 h-100 d-flex flex-column " >
                ...
                <div className="card-body ">
                    <h4 className="card-title text-black"> {_("TEAM." + props.name)} </h4>
                    <h5 className="card-subtitle text-muted"> {_("TEAM." + props.title)}<ItemLink/> </h5>
