        ...
        <div className="ms-base-page pb-5 emotion">
            ...
            <section className="pb-5">
                <div className="row g-5 py-3">
                    ...
                    <div className="col-lg-6">
                        <ImageI18N src="/img/page/emotion/emotion-screen-april-en.webp" w={512} h={598} cls="ms-base-image" alt={_("EMOTION.ALT1")} />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gray py-5">
                <div className="row g-5 mt-3 py-5">
                    ...
                    <div className="col-lg-6 d-table order-lg-first pt-lg-0 pt-5">
                        <ImageI18N src="/img/page/emotion/emotion-diagram.webp" w={512} h={367} cls="img-fluid mx-lg-0 px-0" alt={_("EMOTION.ALT2")} />
                    </div>
                </div>
                ...
                <div className="row g-5">
                    <div className="col-lg-6 d-table">
                        <div className="d-table-cell align-middle">
                            ...
                            <ImageI18N src="/img/page/emotion/emotion-screen-stress-en.webp" w={512} h={522} cls="ms-base-image d-block d-lg-none py-5" alt={_("EMOTION.ALT3")} />
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-6 d-table">
                        <div className="d-table-cell align-middle">
                            ...
                            <ImageI18N src="/img/page/emotion/emotion-screen-test-en.webp" w={390} h={512} cls="ms-base-image d-block d-lg-none py-5" alt={_("EMOTION.ALT4")} />
            ...
            <section className="pt-5">
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-4 col-6">
                        <div className="icon mb-5"><img src="/img/emotion/emotion-icon-11.svg" alt="" /></div>
                ...
                <div className="row py-5 text-lg-start text-center">
                    <div className="d-flex flex-lg-row flex-column block bg-violet">
                        ...
                        <div className="col-lg-6 col-8 mx-auto">
                            <ImageI18N src="/img/page/emotion/emotion-screen-app-en.webp" w={400} h={400} cls="img-fluid ms-lg-auto me-lg-0 py-lg-0 py-5" alt={_("EMOTION.ALT4")} />
                        </div>
                    </div>
                </div>
            </section>
