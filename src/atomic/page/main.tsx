...
export default function LandingPage() {
    ...
    return (
        <div>
            <NavigationBar />
            <div className="ms-base-page ms-s-offset home">
                <Header
                    title={_("MAIN.HEAD")}
                    rowItems={
                        <>
            ...
            <section className="ms-base-page ms-s-offset home section">
            ...
            <section className="ms-base-pag ms-s-offset section">
            ...
            <section className="ms-base-page ms-s-offset">
                <Review
                    appId={pick.id}
                    codes={{
