        ...
        <div className="flex-grow-1 flex-shrink-0">
            ...
            <section className="ms-s-product">
                <div className="ms-s-offset">
                    ...
                    <div className="col p-container">
                        <div className="d-flex p-head">
                            <img src="/img/page/body_mass/logo_mass.svg" className="img-fluid me-3" height={48} width={48} alt={_("MASS.ICO")} />
                            <div>
                                <h1>{_("MASS.HEAD")}</h1>
                                <p>{_("MASS.SUBHEAD")}</p>
                            </div>
                        ...
                        <div className="p-img">
                            <ImageI18N src="/img/page/body_mass/mass.en.512.webp" w={512} h={512} cls="mx-auto my-4 px-lg-4 px-0 img-fluid" alt={_("MASS.IMG")} />
                        </div>
                        <div className="p-text">
                            <h4>{_("MASS.TEXT")}</h4>
            ...
            <section className="ms-s-product">
                <div className="ms-s-offset">
                    ...
                    <div className="col p-container">
                        <div className="d-flex p-head">
                            <img src="/img/page/emotion/logo_emotion.svg" className="img-fluid me-3" height={48} width={48} alt={_("EMOTION.ICO")} />
                            <div>
                        ...
                        <div className="p-img">
                            <ImageI18N src="/img/page/emotion/emotion_home.en.webp" w={512} h={512} cls="mx-auto my-4 img-fluid" alt={_("EMOTION.IMG")} />
                        </div>
                        <div className="p-text">
