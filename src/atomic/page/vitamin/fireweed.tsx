...
export default function Fireweed() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`/src/data/article/vitamin/fireweed/fireweed-${Locale.language}.json`);
                                    ...
                                    {hasRightColumn && item.RIGHT_COLUMN && (
                                        <aside className="article-section__right">
                                            {item.RIGHT_COLUMN.CONTENT && (
                                                <ReactMarkdown>{item.RIGHT_COLUMN.CONTENT}</ReactMarkdown>
                                            )}
