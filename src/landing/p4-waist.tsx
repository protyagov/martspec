...
export default function P4Waist() {
    return (
        <div>
            <MetaTags>
                <meta property="og:title" content={_("MAIN.P1_HEAD")} />
                <meta property="og:image" content={"https://recruiter.reviews" + logo} />
                <meta property="og:description" content={_("MAIN.P4_TEXT")} />

                <title>{_("MAIN.P4_HEAD")}</title>
                <meta name="description" content={_("MAIN.P4_TEXT")} />
            </MetaTags>
