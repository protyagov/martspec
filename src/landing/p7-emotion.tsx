        ...
        <div className="ms-base-page pb-5 emotion">
            ...
            <section className="pb-5">
                <div className="row g-4">
                    ...
                    <div className="col-md-8 order-md-4">
                        <div className="block bg-violet">
            ...
            <section>
                <div className="row py-5 text-md-start text-center">
                    <div className="d-flex flex-md-row flex-column block bg-violet">
                        <div className="col-md-6 col-12 d-flex flex-column">
                            <h2>{_("EMOTION.HEAD8")}</h2>
                            <p className="flex-grow-1">{_("EMOTION.DESK8")}</p>
                            <a href={`https://apps.apple.com/${_("COUNTRY_CODE")}/app/id1562956213?l=${Locale.language}`}
                                target="_blank" title={_("EMOTION.DWN")} className="ms-btn-apple my-5 mx-md-0 mx-auto"
                                style={{ backgroundImage: 'url(/img/apple_btn/' + Locale.language + '.svg)' }}>
                            </a>
                        </div>
