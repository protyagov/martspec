    ...
    return <>
        ...
        <div className="ms-base-page pb-5 emotion">
                    ...
                    <div className="col-lg-6 d-table">
                        <div className="d-table-cell align-middle">
                            ...
                            <ul className="why-list">
                                <li>Людей стремящиеся к саморазвитию</li>
                                <li>Людям, для лучшего понимания партнера</li>
                                <li>Студентам при подготовке к тестам или экзаменам</li>
                                <li>Любителям заниматься  фитнесом и спорта</li>
                                <li>Исследования аналитики данных</li>
                                <li>Клиент реабилитационных центров</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section>
                ...
                <div className="row spheres-list">
