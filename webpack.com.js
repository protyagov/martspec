...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ template: './src/template/en/vitamin/vitamin_a.ejs', filename: 'vitamin/vitamin_a.html', inject: 'body' }),new HtmlWebpackPlugin({ template: './src/template/en/vitamin/vitamin_d.ejs', filename: 'vitamin/vitamin_d/index.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_d.ejs`, filename: 'vitamin/vitamin_d/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_e.ejs`, filename: 'vitamin/vitamin_e/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_k.ejs`, filename: 'vitamin/vitamin_k/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b1.ejs`, filename: 'vitamin/vitamin_b1/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b2.ejs`, filename: 'vitamin/vitamin_b2/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b3.ejs`, filename: 'vitamin/vitamin_b3/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b5.ejs`, filename: 'vitamin/vitamin_b5/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b6.ejs`, filename: 'vitamin/vitamin_b6/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b7.ejs`, filename: 'vitamin/vitamin_b7/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b9.ejs`, filename: 'vitamin/vitamin_b9/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b12.ejs`, filename: 'vitamin/vitamin_b12/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_c.ejs`, filename: 'vitamin/vitamin_c/index.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_d.ejs`, filename: 'vitamin/vitamin_d.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_e.ejs`, filename: 'vitamin/vitamin_e.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_k.ejs`, filename: 'vitamin/vitamin_k.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b1.ejs`, filename: 'vitamin/vitamin_b1.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b2.ejs`, filename: 'vitamin/vitamin_b2.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b3.ejs`, filename: 'vitamin/vitamin_b3.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b5.ejs`, filename: 'vitamin/vitamin_b5.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b6.ejs`, filename: 'vitamin/vitamin_b6.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b7.ejs`, filename: 'vitamin/vitamin_b7.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b9.ejs`, filename: 'vitamin/vitamin_b9.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_b12.ejs`, filename: 'vitamin/vitamin_b12.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/vitamin_c.ejs`, filename: 'vitamin/vitamin_c.html', inject: 'body' }),
    ])]),
    //--------------------------------------------------------------------------------------------------------------------------------------------
    resolve: {
