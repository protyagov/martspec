...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ template: './src/template/en/coming-soon.ejs', filename: 'coming-soon.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: './src/template/${x}/coming-soon.ejs', filename: x + 'coming-soon/index.html', inject: 'body' }),
