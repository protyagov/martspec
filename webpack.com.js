...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ template: './src/template/en/vitamin/iodine.ejs', filename: 'vitamin/vitamin_b1/index.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: './src/template/en/vitamin/iodine.ejs', filename: 'vitamin/vitamin_b1.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/calcium.ejs`, filename: 'vitamin/calcium/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/chloride.ejs`, filename: 'vitamin/chloride/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/chrome.ejs`, filename: 'vitamin/chrome/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/copper.ejs`, filename: 'vitamin/copper/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/iodine.ejs`, filename: 'vitamin/vitamin_b1/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/iron.ejs`, filename: 'vitamin/iron/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/magnesium.ejs`, filename: 'vitamin/magnesium/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/manganese.ejs`, filename: 'vitamin/manganese/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/molybdenum.ejs`, filename: 'vitamin/molybdenum/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/phosphorus.ejs`, filename: 'vitamin/phosphorus/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/potassium.ejs`, filename: 'vitamin/potassium/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/selenium.ejs`, filename: 'vitamin/selenium/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/sodium.ejs`, filename: 'vitamin/sodium/index.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/zinc.ejs`, filename: 'vitamin/zinc/index.html', inject: 'body' }),
        ...
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/calcium.ejs`, filename: '/vitamin/calcium.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/chloride.ejs`, filename: '/vitamin/chloride.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/chrome.ejs`, filename: '/vitamin/chrome.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/copper.ejs`, filename: '/vitamin/copper.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/iodine.ejs`, filename: '/vitamin/vitamin_b1.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/iron.ejs`, filename: '/vitamin/iron.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/magnesium.ejs`, filename: '/vitamin/magnesium.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/manganese.ejs`, filename: '/vitamin/manganese.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/molybdenum.ejs`, filename: '/vitamin/molybdenum.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/phosphorus.ejs`, filename: '/vitamin/phosphorus.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/potassium.ejs`, filename: '/vitamin/potassium.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/selenium.ejs`, filename: '/vitamin/selenium.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/sodium.ejs`, filename: '/vitamin/sodium.html', inject: 'body' }),
        new HtmlWebpackPlugin({ template: `./src/template/${x}/vitamin/zinc.ejs`, filename: '/vitamin/zinc.html', inject: 'body' }),
    ])]),
    //--------------------------------------------------------------------------------------------------------------------------------------------
    resolve: {
