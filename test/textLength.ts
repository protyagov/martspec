...
const testEntities: ITestEntity[] = [
    ...
    // long review
    {
        ...
        entry: "We had just moved to a new apartment and didn't have a mattress yet, so we went shopping. We visited several of the more traditional mattress stores but always left with a feeling that the salesperson was pissed that we didn't close the deal on the spot, which made us want to close the deal even less. When we entered the Casper store, we were greeted by a super-friendly employee who made everything to ensure we were comfortable when trying the different mattresses. She understood our budget and didn't push the more expensive mattresses needlessly. We weren't ready to buy the mattress right there, but we left with a quote in our email and made the purchase later in the week. It was a very smooth process. When the mattress arrived, we had been sleeping on an air mattress for a while, and needless to say, it was the best night of sleep ever. We've been using the Dream for a couple of weeks and love it!",
        expect: "We had just moved to a new apartment and didn't have a mattress yet, so we went shopping. We visited several of the more traditional mattress stores but always left with a feeling that the salesperson...",
    },
    {
